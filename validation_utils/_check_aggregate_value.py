...
# the LIFE package and the data/ directory live -- add the repo root to the
# path so `import LIFE...` resolves, and anchor data paths to it below so this
# still works regardless of the working directory it's invoked from.
...
species_info_path = REPO_ROOT / "data" / "inputs" / "species-info"
